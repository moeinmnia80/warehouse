  ...
  return (
    <div className="flex gap-12 w-full h-32 bg-b-primary rounded-2xl p-5 animate-slide-down">
      <div className="flex flex-col justify-between h-full w-fit">
        ...
        <p className="text-t-secondary text-lg font-medium">
      ...
      <div className=" w-px h-full bg-bo-primary"></div>
      <div
        className="flex gap-4 bg-b-secondary 
        border border-bo-primary rounded-xl p-4"
      >
        <div className="h-full aspect-square rounded-lg bg-primary p-2">
          <QueueIcon className="size-full stroke-st-primary" />
        </div>
        <div className="">
          <div className="text-t-primary text-2xl font-bold">08</div>
          <Link
            className="text-t-primary text-md font-semibold underline"
            to="/queue"
          >
            View Queue
          </Link>
