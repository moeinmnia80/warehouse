...
const Layout = ({ children }: ComponentPropsWithoutRef<"div">) => {
  ...
  return (
    <>
      <Header className="header sticky top-0 z-30 bg-b-primary px-5 md:px-20 border-b border-bo-primary" />

      <main className="relative flex bg-b-secondary w-full px-5 md:px-10 lg:px-15 min-h-dvh">
        <ToastContainer />
        {children}
      </main>
      {shouldShowFooter && (
